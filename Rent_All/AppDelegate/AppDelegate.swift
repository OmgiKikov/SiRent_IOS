...
class AppDelegate: UIResponder, UIApplicationDelegate,UNUserNotificationCenterDelegate {
        ...
        if ((Utility.shared.getCurrentUserToken()) == nil || (Utility.shared.getCurrentUserToken()) == ""){
          if view!.count > 0{
            if view!.contains("password"){
              ...
              let resetPasswordPage = ForgotPasswordViewController()
  ...
  func application(_ app: UIApplication, open url: URL,
    ...
    if let scheme = url.scheme,
       scheme.localizedCaseInsensitiveCompare("com.SiRent.adigium") == .orderedSame,
       let view = url.host {
  ...
  func configureDynamicData(){
    ...
    if Utility.shared.getTabbar() != nil && Utility.shared.getTabbar() == true{
      if((Utility.shared.getCurrentUserToken()) == nil || (Utility.shared.getCurrentUserToken()) == ""){
        ...
        let welcomepage = SignInViewController()
