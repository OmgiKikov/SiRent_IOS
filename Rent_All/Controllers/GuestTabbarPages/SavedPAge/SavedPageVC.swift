...
//        statusBarView.backgroundColor = UIColor.white
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(whishlistarray[indexPath.row].wishListCount! >= 1)
        {
           ...
           // cell.titleLabel.attributedText = Utility.shared.getAtrributedstring(fullString: "\(whishlistarray[indexPath.row].name!) \(whishlistarray[indexPath.row].wishListCount!) Home\(whishlistarray[indexPath.row].wishListCount! > 1 ? "s" : "")", ChangedString: "\(whishlistarray[indexPath.row].wishListCount!) Home\(whishlistarray[indexPath.row].wishListCount! > 1 ? "s" : "")")
