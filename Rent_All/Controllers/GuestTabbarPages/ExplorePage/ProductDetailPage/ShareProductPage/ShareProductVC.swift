...
class ShareProductVC: UIViewController,UITableViewDelegate,UITableViewDataSource,MFMailComposeViewControllerDelegate,MFMessageComposeViewControllerDelegate {
    ...
    func registerCells(){
        ...
        self.backgrndImage.sd_setImage(with: URL(string:"\(IMAGE_LISTING_MEDIUM)\(String(describing: profileimage))"), placeholderImage: #imageLiteral(resourceName: "ItemTransparentImg"))
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if(indexPath.section == 0){
            ...
            let profileimage = viewListingArray.listPhotoName!
            cell.productImg.sd_setImage(with: URL(string:"\(IMAGE_LISTING_MEDIUM)\(String(describing: profileimage))"), placeholderImage: #imageLiteral(resourceName: "ItemTransparentImg"))
            ...
            cell.shareTitle.font = UIFont(name: "Circular-Book", size:19)
            cell.selectionStyle = UITableViewCell.SelectionStyle.none
            return cell
        }
    }
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(indexPath.section==1){
            if(indexPath.row == 0){
                ...
                let profileimage = viewListingArray.id!
                let urltoShare =  "\(SHARE_URL)\(String(describing: profileimage))"
                ...
                let profileimage = viewListingArray.id!
                let objectsToShare:URL =  URL(string:"\(SHARE_URL)\(String(describing: profileimage))")!
