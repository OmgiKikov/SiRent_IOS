...
//            let long: CLLocationDegrees = (index as AnyObject).value(forKey: "lon")as! CLLocationDegrees
//            let lat: CLLocationDegrees = (index as AnyObject).value(forKey: "lat")as! CLLocationDegrees
//                //(self.locationDetailArray .object(at: index as! Int)as AnyObject).value(forKey: "lat") as! CLLocationDegrees
...
//            let currency : String = (index as AnyObject).value(forKey: "currency") as! String
//            let price :  String = (index as AnyObject).value(forKey: "price") as! String
