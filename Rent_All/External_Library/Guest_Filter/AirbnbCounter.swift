...
class AirbnbCounter: UIView {
    ...
    var captionLabel: UILabel = {
      ...
      //  view.textColor = UIColor.white
        view.textColor = Theme.PRIMARY_COLOR
        return view
    }()
    ...
    lazy var decrementButton: UIButton = {
        ...
        button.setImage(UIImage(named: "substract", in: Bundle(for: AirbnbOccupantFilter.self), compatibleWith: nil), for: .normal)
    ...
    var incrementButton: UIButton = {
        let button = UIButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "add", in: Bundle(for: AirbnbOccupantFilter.self), compatibleWith: nil), for: .normal)
        button.imageEdgeInsets = UIEdgeInsets(top: 7, left: 7, bottom: 7, right: 7)
