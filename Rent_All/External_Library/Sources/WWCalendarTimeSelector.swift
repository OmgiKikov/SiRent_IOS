...
//
//        headerView.priceValue = _SpecialPrice
//        headerView.currency = Currency
//        self.addChild(headerView)
//        headerView.view.frame = CGRect(x: 0, y:-150, width: FULLWIDTH+30, height: FULLHEIGHT)
...
//
    ...
    // Fonts & Colors
    open var optionCalendarFontMonth = UIFont(name: "Circular-Medium", size: 18)
    open var optionCalendarFontDays = UIFont(name: "Circular-Book", size: 15)
    open var optionCalendarFontToday = UIFont(name: "Circular-Bold", size: 15)
    open var optionCalendarFontTodayHighlight = UIFont(name: "Circular-Bold", size: 15)
    open var optionCalendarFontPastDates = UIFont(name: "Circular-Medium", size: 15)
    open var optionCalendarFontPastDatesHighlight = UIFont(name: "Circular-Book", size: 15)
    open var optionCalendarFontFutureDates = UIFont(name: "Circular-Book", size: 15)
    open var optionCalendarFontFutureDatesHighlight = UIFont(name: "Circular-Book", size: 15)
    ...
    open var optionCalendarFontColorTodayHighlight = Theme.PRIMARY_COLOR
    ...
    open var optionCalendarFontCurrentYear = UIFont(name: "Circular-Medium", size: 18)
    open var optionCalendarFontCurrentYearHighlight = UIFont(name: "Circular-Medium", size: 20)
    ...
    open var optionCalendarFontPastYears = UIFont(name: "Circular-Medium", size: 18)
    open var optionCalendarFontPastYearsHighlight = UIFont(name: "Circular-Medium", size: 20)
    ...
    open var optionCalendarFontFutureYears = UIFont(name: "Circular-Medium", size: 18)
    open var optionCalendarFontFutureYearsHighlight = UIFont(name: "Circular-Medium", size: 15)
    ...
    open var optionClockFontAMPM = UIFont(name: "Circular-Book", size: 15)
    open var optionClockFontAMPMHighlight = UIFont(name: "Circular-Book", size: 15)
    ...
    open var optionClockFontHour = UIFont(name: "Circular-Book", size: 16)
    open var optionClockFontHourHighlight = UIFont(name: "Circular-Medium", size: 18)
    ...
    open var optionClockFontMinute = UIFont(name: "Circular-Book", size: 12)
    open var optionClockFontMinuteHighlight = UIFont(name: "Circular-Book", size: 14)
    ...
    open var optionButtonFontCancel = UIFont(name: "Circular-Book", size: 16)
    open var optionButtonFontDone = UIFont(name: "Circular-Medium", size: 16)
    ...
    open var optionTopPanelFont = UIFont(name: "Circular-Book", size: 15)
    open var optionTopPanelFontColor = UIColor.white
    
    open var optionSelectorPanelFontMonth = UIFont(name: "Circular-Book", size: 15)
    open var optionSelectorPanelFontDate = UIFont(name: "Circular-Book", size: 15)
    open var optionSelectorPanelFontYear = UIFont(name: "Circular-Book", size: 15)
    open var optionSelectorPanelFontTime = UIFont(name: "Circular-Book", size: 15)
    open var optionSelectorPanelFontMultipleSelection = UIFont(name: "Circular-Book", size: 15)
    open var optionSelectorPanelFontMultipleSelectionHighlight = UIFont(name: "Circular-Book", size: 16)
                ...
                if date.weekday == i {
                     ...
                     if(Utility.shared.host_blockedDates_Array.contains(fmt.string(from: date)))
                    {
                     ...
                     else if(Utility.shared.host_bookedPricing_Array.contains(fmt.string(from: date)))
                     {
                        ...
                        fontHighlightColor = BOOKING_PRICING_COLOR
                    ...
                    if fmt.string(from: date) == fmt.string(from: today) {
                        ...
                        if(Utility.shared.host_specialPricing_Array.contains(fmt.string(from: today)))
                        {
                            ...
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:SPECIAL_PRICING_COLOR,NSAttributedString.Key.underlineColor:SPECIAL_PRICING_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                        ...
                        {
                             print("\(date.day)")
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:Red_color,NSAttributedString.Key.underlineColor:Red_color,NSAttributedString.Key.paragraphStyle: paragraph])
                            str.addAttribute(NSAttributedString.Key.underlineStyle , value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0,str.length))
                        ...
                        if(Utility.shared.host_bookedPricing_Array.contains(fmt.string(from: today)))
                        {
                            ...
                            str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:BOOKING_PRICING_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                        ...
                        else
                        {
                            ...
                            if (date == today) && Utility.shared.isTodayEnable == true && sampleDateArray.contains(fmt.string(from: today)){
                                ...
                                if Utility.shared.isTodayEnable == true{
                                    ...
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.clear,NSAttributedString.Key.foregroundColor:UIColor.white,NSAttributedString.Key.paragraphStyle: paragraph])
                                }else {
                                    
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:UIColor.darkText,NSAttributedString.Key.paragraphStyle: paragraph])
                                }
                                ...
                                if Utility.shared.host_blockedDates_Array.contains(fmt.string(from: today)){
                                    ...
                                    str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font:UIFont(name: "Circular-Medium", size: 15), NSAttributedString.Key.backgroundColor:UIColor.white,NSAttributedString.Key.foregroundColor:UIColor.darkGray,NSAttributedString.Key.paragraphStyle: paragraph])
                                    //str.addAttribute(NSAttributedString.Key.strikethroughStyle, value: NSUnderlineStyle.single.rawValue, range: NSMakeRange(0, str.length))
...
//                        ctx?.fillEllipse(in: CGRect(x: x, y: y, width: size, height: size))
                        ...
                        if(date == today)
                        {
                         str = NSMutableAttributedString(string: "\(date.day)", attributes: [NSAttributedString.Key.font: font!, NSAttributedString.Key.foregroundColor:Theme.PRIMARY_COLOR, NSAttributedString.Key.paragraphStyle: paragraph])
                        }
                        else
                        {
            ...
            for i in 1...7 {
                if date.weekday == i {
                    if date == flashDate {
                        ...
                        if flashDate == today {
                            flashColor = Theme.PRIMARY_COLOR
                        }
