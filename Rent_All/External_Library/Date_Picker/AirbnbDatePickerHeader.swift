...
class AirbnbDatePickerHeader: UIView {
    ...
    func setupSlashView() {
        ...
        slashView.topAnchor.constraint(equalTo: topAnchor, constant: 45).isActive = true
        if IS_IPHONE_XR || IS_IPHONE_PLUS{
            
            slashView.leftAnchor.constraint(equalTo: startDayLabel.rightAnchor, constant: 20).isActive = true
            ...
            slashView.heightAnchor.constraint(equalToConstant: 50).isActive = true
        }
